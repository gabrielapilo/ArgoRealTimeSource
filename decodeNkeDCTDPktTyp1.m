...
% --------------------------------------------------------------------------------
% Packet type Code: 0x01
% This message contains float's Descent TS information
%
% Reference:
...
fnam = ['/home/argo/ARGO_RT/Nke_data/processed/' num2str(wmoid) '/ctd/Desctd' cyc_num '.txt'];
fid = fopen(fnam,'a');
