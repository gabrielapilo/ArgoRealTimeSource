...
for kk = ical(:)'
    ...
    if nargin == 2
        ...
        if fp.wmo_id==1901121 | fp.wmo_id==1901324 | fp.wmo_id==1901321 | ...
                ...
                fp.wmo_id==5903252 | fp.wmo_id==5903227 | fp.wmo_id==5903667 | fp.wmo_id==5904228
            calibrate=0;
    ...
    elseif kk>1 && ~isempty(float(kk-1).c_ratio) && calibrate
        ...
        % Can't calibrate, and no previous value to use. Or we don't want to
        % calibrate
        fp.c_ratio = 1.;
        fp.deltaS = [];
    end
