...
a1 = sprintf(['ser# = %s temperature coeffs: A0 = %8.10f A1 = %8.10f ' ...
	      'A2 = %8.10f A3 = %8.10f '],...
	     sbeSN, caldb.TA0, caldb.TA1, caldb.TA2, caldb.TA3);
a2 = sprintf(['ser# = %s conductivity coeffs: G = %8.10f H = %8.10f I = %8.10f' ...
	      ' J = %8.10f CPCOR = %8.10f CTCOR = %8.10f WBOTC = %8.10f '],...
...
if dbdat.oxy
    ...
    if isfield(fpp,'SBEOxyfreq_raw')  %        case {22, 38}  case{1007, 1008} % convertFREQoxygen    
        if dbdat.subtype==22 | dbdat.subtype==38
            ...
            a4 = sprintf(['ser# = %s oxygen coeffs: a0 = %8.10f a1 = %8.10f ' ...
                'a2 = %8.10f a3 = %8.10f '],...
            ...
            a4 = sprintf(['ser# = %s oxygen coeffs: a0 = %8.10f a1 = %8.10f ' ...
                'a2 = %8.10f a3 = %8.10f B0 = -6.24523e-3 '...
    ...
    if isfield(fpp,'Bphase_raw')  %    case {1002, 1012, 1006, 1020}  % convertBphase
           if isempty(cal.a7) | cal.a7==0
               a4 = sprintf(['ser# = %s oxygen coeffs: a0 = %8.10f a1 = %8.10f ' ...
                   'a2 = %8.10f a3 = %8.10f a4 = %8.10f a5 = %8.10f a6 = %8.10f '], ...
               ...
               a4 = sprintf(['ser# = %s oxygen coeffs: a0 = %8.10f a1 = %8.10f ' ...
                   'a2 = %8.10f a3 = %8.10f a4 = %8.10f a5 = %8.10f ' ...
                   'a6 = %8.10f a7 = %8.10f a8 = %8.10f a9 = %8.10f ' ...
                   'a10 = %8.10f a11 = %8.10f a12 = %8.10f a13 = %8.10f '],...
                   num2str(cal.O2_snum), cal.a0, cal.a1, cal.a2, cal.a3, cal.a4, cal.a5, cal.a6, ...
	...
	if isfield(fpp,'Tphase_raw')  %case {1022}  % convertTphase Modified by uday ===============
        if isempty(cal.a7) | cal.a7==0
            ...
            a4 = sprintf(['ser# = %s oxygen coeffs: a0 = %8.10f a1 = %8.10f ' ...
                'a2 = %8.10f a3 = %8.10f a04 = %8.10f a5 = %8.10f ' ...
                'a6 = %8.10f a7 = %8.10f a8 = %8.10f a9 = %8.10f ' ...
                'a10 = %8.10f a11 = %8.10f a12 = %8.10f a13 = %8.10f ',...
                'a14 = %8.10f a15 = %8.10f a16 = %8.10f a17 = %8.10f ',...
                'a18 = %8.10f a19 = %8.10f a20 = %8.10f a21 = %8.10f ',...
                'a22 = %8.10f a23 = %8.10f a24 = %8.10f a25 = %8.10f ',...
                'a26 = %8.10f a27 = %8.10f a28 = %8.10f a29 = %8.10f ',...
                'a30 = %8.10f '],...
                num2str(cal.O2_snum), cal.a0, cal.a1, cal.a2, cal.a3, cal.a4, cal.a5, cal.a6, ...
    ...
    if isfield(fpp,'O2phase_raw')   % case 1017    % convertSBE63Oxy
        a4 = sprintf(['ser# = %s  oxygen coeffs: s1 = 0 a0 = %8.10f a1 = %8.10f ' ...
            'a2 = %8.10f b0 = %8.10f b1 = %8.10f c0 = %8.10f  c1 = %8.10f c2 = %8.10f e = %8.10f'],...
        ...
        if isfield(fpp,'t_oxygen_volts')    % convertSBE63Tv
            jj=jj+1;
            a4 = sprintf(['ser# = %s  oxygen coeffs: T0 = %8.10f T1 = %8.10f T2 = %8.10f ' ...
                'T3 = %8.10f' ],...
...
% There is chla missing here, between Freq Doxy and FLBB chla; should I add
% jj = jj + 1????
...
if dbdat.flbb
    ...
    jj=jj+1; % CHLA
    a4 = sprintf(['ser# = %s FLBB CHLA coeffs: Scale = %8.10f  Dark Counts = %8.10f' ],...
    ...
    jj=jj+1; % BBP
    jjbbp = jj;
    a4 = sprintf(['ser# = %s FLBB 700 BBP coeffs: Scale = %8.10f  Dark Counts = %8.10f'  ...
        ' FLBBangle = %8.10f  FLBBChi = %8.10f'],...
    ...
    if isfield(fpp,'CDOM_raw')  %dbdat.subtype==1006
        ...
        a4 = sprintf(['ser# = %s FLBB CDOM coeffs: Scale = %8.10f  Dark Counts = %8.10f' ],...
...
if dbdat.flbb2
    ...
    a4 = sprintf(['ser# = %s FLBB 532 BBP coeffs: Scale = %8.10f  Dark Counts = %8.10f'  ...
        ' FLBBangle = %8.10f  FLBBChi = %8.10f'],...
...
if dbdat.eco
    ...
    cal=THE_ARGO_BIO_CAL_DB(kk);
    jj=jj+1; % BBP 700 - Eco
    a4 = sprintf(['ser# = %s ECO 700 BBP coeffs: Scale = %8.10f Eco 700 Dark Counts = %8.10f'  ...
        ' ECO 700angle = %8.10f ECO 700 Chi = %8.10f'],...
    ...
    netcdf.putVar(ncid,PREDEPCALEQNID,[0,jj-1],[length(a4),1],a4);
    jj=jj+1; % BBP532 - Eco
    a4 = sprintf(['ser# = %s FLBB 532 BBP coeffs: Scale = %8.10f Eco 532 Dark Counts = %8.10f'  ...
        ' Eco 532 angle = %8.10f  Eco 532 Chi = %8.10f'],...
    ...
    netcdf.putVar(ncid,PREDEPCALEQNID,[0,jj-1],[length(a4),1],a4);
    jj=jj+1; % % BBP532 - Eco
    a4 = sprintf(['ser# = %s FLBB 470 BBP coeffs: Scale = %8.10f  Dark Counts = %8.10f'  ...
        ' FLBB470angle = %8.10f  FLBB470Chi = %8.10f'],...
...
if dbdat.tmiss
    ...
    a4 = sprintf(['ser# = %s Transmissometer CP coeffs: Reference = %8.10f  Dark Counts = %8.10f  Path Length = 25' ],...
...
% Adds comments to fixed BPP scaling factors; GP Dec/2019
% if fpp(end).wmo_id == 5903629 | fpp(end).wmo_id == 5903955;
if dbdat.flbb;
    jj = jjbbp; % location of BPP 700
    txt_comm = ['Reprocessed from the file provided by Andrew Barnard (Seabird) following ADMT18. ' ...
        'This file is accessible at http://doi.org/10.17882/545'];
    netcdf.putVar(ncid,PREDEPCALCOMMID,[0,jj-1],[length(txt_comm),1],txt_comm);   
end
