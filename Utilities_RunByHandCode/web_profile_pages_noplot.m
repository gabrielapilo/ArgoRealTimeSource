...
%   viewed in that page.  Thsi has been modified to only regenerate teh
%   html code, not the plots themselves...
%
...
function web_profile_pages_noplot(fp,db)
...
a=['<td><a href="http://www.cmar.csiro.au/mr/argo/tech/AU/',num2str(db.maker_id),'/Hull_',num2str(db.maker_id),'.html"> Technical Pages</a></td>\n'];
fprintf(fid,a);
...
%       if db.subtype==1006   % this has its own p t and s scales
